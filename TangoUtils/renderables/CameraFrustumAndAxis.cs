...
namespace com.projecttango.tangoutils.renderables
{
    ...
    public class CameraFrustumAndAxis : Renderable
	{
		...
		private const string sFragmentShaderCode = "precision mediump float;" + "varying vec4 vColor;" + "void main() {" + "gl_FragColor = vColor;" + "}";
		...
		public override void draw(float[] viewMatrix, float[] projectionMatrix)
		{
			lock (this)
			{
				...
				GLES20.GlDrawArrays(GLES20.GlLines, 0, mVertices.Length / 3);
