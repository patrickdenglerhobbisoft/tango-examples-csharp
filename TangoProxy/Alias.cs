...
namespace android
{
    ...
    //namespace runtime { using runtime = Android.Runtime; }
    //namespace widget { using Button = Android.Widget.Button; }
    //namespace app { using app = Android.App; }
    //namespace content { using content = Android.Content;}
    //namespace view { using view = Android.Views; }
    //namespace activity { using activity = Android.App.Activity;}
    //namespace annotation { using annoation = Android.Annotation;}
    ...
    namespace opengl
    {
        ...
        using GLES20ORIGINAL = Android.Opengl.GLES20;
        public partial class Matrix
        {
            public static void SetIdentityM(float[] ModelMatrix, int p)
            {
                throw new NotImplementedException();
            }

            public static void SetLookAtM(float[] mViewMatrix, int p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10)
            {
                throw new NotImplementedException();
            }

            public static void invertM(float[] invertModelMat, int p1, float[] p2, int p3)
            {
                throw new NotImplementedException();
            }

            public static void multiplyMM(float[] temporaryMatrix, int p1, float[] mViewMatrix, int p2, float[] invertModelMat, int p3)
            {
                throw new NotImplementedException();
            }

            public static void perspectiveM(float[] mProjectionMatrix, int p, float CAMERA_FOV, float mCameraAspect, float CAMERA_NEAR, float CAMERA_FAR)
            {
                throw new NotImplementedException();
            }
        }
        ...
        public partial class GLES20
        {
            ...
            public static int GlDepthBufferBit = 0x00000100;
            public static int GL_STENCIL_BUFFER_BIT = 0x00000400;
            public static int GlColorBufferBit = 0x00004000;
            ...
            public static int GlDepthTest = 0x0B71;
            ...
            #endregion
            public static void glAttachShader(int mProgram, int vertexShader)
            {
                GLES20ORIGINAL.GlAttachShader(mProgram, vertexShader);
            }

            public static int glCreateProgram()
            {
                return GLES20ORIGINAL.GlCreateProgram();
            }

            public static void glLinkProgram(int mProgram)
            {
                GLES20ORIGINAL.GlLinkProgram(mProgram);
            }

            public static void glUseProgram(int mProgram)
            {
                GLES20ORIGINAL.GlUseProgram(mProgram);
            }

            public static int glGetAttribLocation(int mProgram, string p)
            {
                return GLES20ORIGINAL.GlGetAttribLocation(mProgram, p);
            }

       
            public static void glEnableVertexAttribArray(int mPosHandle)
            {
                GLES20ORIGINAL.GlEnableVertexAttribArray(mPosHandle);
            }

            public static int glGetUniformLocation(int mProgram, string p)
            {
                return GLES20ORIGINAL.GlGetUniformLocation(mProgram, p);
            }

            public static void glUniformMatrix4fv(int mMVPMatrixHandle, int p1, bool p2, float[] MvpMatrix, int p3)
            {
                GLES20ORIGINAL.GlUniformMatrix4fv(mMVPMatrixHandle, p1, p2, MvpMatrix, p3);
            }

            public static void glDrawArrays(int p1, int p2, int mPointCount)
            {
                GLES20ORIGINAL.GlDrawArrays(p1, p2, mPointCount);
            }
            ...
            public static void glLineWidth(int p)
            {
                GLES20ORIGINAL.GlLineWidth(p);
            }

            public static void glUniform4f(int mColorHandle, float p1, float p2, float p3, float p4)
            {
                GLES20ORIGINAL.GlUniform4f(mColorHandle, p1, p2, p3, p4);
            }

            public static void glShaderSource(int shader, string shaderCode)
            {
                GLES20ORIGINAL.GlShaderSource(shader, shaderCode);
            }

            public static int glCreateShader(int type)
            {
                return GLES20ORIGINAL.GlCreateShader(type);
            }

            public static void glCompileShader(int shader)
            {
                GLES20ORIGINAL.GlCompileShader(shader);
            }
        }
    }
...
{
    public static class MotionEvenEnums
    {
        public static int ACTION_MASK = 0xff;
...
namespace Com.Google.Atap.Tangoservice
{
    ...
    using OnTangoUpdateListener = Com.Google.Atap.Tangoservice.Tango.IOnTangoUpdateListener;
    using TangoConfig = Com.Google.Atap.Tangoservice.TangoConfig;
